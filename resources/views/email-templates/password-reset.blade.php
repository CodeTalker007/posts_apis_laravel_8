                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="logo" style="text-align: center;">
                                <h1><a href="#">Welcome to Grundsteuer Consumer FLow Password Reset.</a></h1>
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em; text-align: center;">
                                    ...
                                    <h3>Dear {{$userName}} this an email from Grundsteuer Consumer Flow. Kindly click on the following button to reset your password</h3>
